...
class PremiumHeroCard extends StatelessWidget {
  ...
  Gradient _getGradient() {
    switch (type) {
      case MvpType.season: return AppColors.goldHeroGradient;
      case MvpType.month: return AppColors.blueDeepHeroGradient;
  ...
  Color _getAccentColor() {
    switch (type) {
      case MvpType.season: return AppColors.neonGold;
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        _StatItem(label: "RATING", value: "8.9", isHighlight: true),
      ],
    );
  }
}
      ...
      children: [
        ...
        Text(
          ...
          style: TextStyle(
            ...
            fontWeight: AppTypography.black,
            color: isHighlight ? AppColors.neonGold : AppColors.white,
          ),
        ),
      ],
    );
