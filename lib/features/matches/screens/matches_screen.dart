...
import 'package:e_sports/core/widgets/filter_chip_widget.dart';
...
class FullMatchCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Color statusColor = isLive ? AppColors.neonRed :
    isCompleted ? AppColors.neonGreen : AppColors.neonBlue;

    return GlassCardWidget(
      padding: const EdgeInsets.all(14),
      borderColor: isLive ? AppColors.neonRed.withOpacity(0.3) : AppColors.glassBorder,
      shadows: [
        BoxShadow(color: (isLive ? AppColors.neonRed : Colors.black).withOpacity(0.2),
      ...
      child: Column(children: [
        ...
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text(match.t1, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w800, color: AppColors.textPrimary)),
          ])),
          Container(
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
            ...
            Text(match.t2, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w800, color: AppColors.textPrimary)),
          ])),
        ]),
        ...
        if (isCompleted && match.resultLabel != null) ...[
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: match.resultType == "win" ? AppColors.neonGreen.withOpacity(0.1) :
              match.resultType == "loss" ? AppColors.neonRed.withOpacity(0.1) :
            ...
            child: Text(match.resultLabel!,
                ...
                style: TextStyle(
                  ...
                  color: match.resultType == "win" ? AppColors.neonGreen :
                  match.resultType == "loss" ? AppColors.neonRed : AppColors.neonGold,
                )),
          ),
        ],
